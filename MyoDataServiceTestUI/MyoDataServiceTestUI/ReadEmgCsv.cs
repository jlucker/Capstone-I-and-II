...
namespace MyoDataServiceTestUI
{
    class ReadEmgCsv
    {
        ...
        public List<CtrlZDataService.EmgData> ReadData()
        {
            List<CtrlZDataService.EmgData> data = new List<CtrlZDataService.EmgData>();
            ...
            while (!reader.EndOfStream)
            {
                ...
                {
                    CtrlZDataService.EmgData newData = new CtrlZDataService.EmgData();
